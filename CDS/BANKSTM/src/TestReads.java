...
*/
    	...
    	final int numAccounts = 10;//Integer.parseInt(args[0]);
        final int numThreads = 10;//Integer.parseInt(args[1]);
        final int numLoops = 10;//Integer.parseInt(args[2]);
        final TestReads ti = new TestReads(numAccounts, "V");
