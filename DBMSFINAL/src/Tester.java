...
public class Tester {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] query = {
				"select * from airports where ID=307326"
				//"Select CONTINENT from countries where CONTINENT=AF",
				//"SELECT department.CONTINENT, countries.CONTINENT FROM countries INNER JOIN department ON department.CONTINENT=countries.CONTINENT"
				...
				//"SELECT airports.ID, countries.ID, countries.NAME FROM airports INNER JOIN countries ON airports.NAME=countries.NAME INNER JOIN department ON department.ID=countries.ID"
 ...
 * "select code, ID from countries where code=\"USEF\" or name=\"Andorra\"",
		...
		//dbs.sortTable("airports", 0, "t1_");
		//dbs.sortTable("countries", 0, "t2_");
		//dbs.sortTable("countries", 2);
		System.out.println("System is ready now to execute the queries :::");
